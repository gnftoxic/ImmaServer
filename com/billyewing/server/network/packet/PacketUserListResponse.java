...
public class PacketUserListResponse
{
    private Client _client;
    private ImmaServer _server;
    private Room _channel;
    
    public PacketUserListResponse(Client c, ImmaServer s)
    {
        _server = s;
        _client = c;
    }
    ...
    public void read(DataInputStream dis) throws IOException
    {
        ...
        if(_client == null)
            _channel = new Room(null, _client);
    }
